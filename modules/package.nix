      ...
      wrapperCheck =
        pkgs.runCommand "phenix-runtime-wrapper-check"
          ...
          ''
            ...
            test "$(phenix-wrapper-fixture)" = "store:0:store"
            test "$(PHENIX_DEV=1 phenix-wrapper-fixture-store)" = "store:0:store"

            mkdir -p "$HOME/phenix/repos/phenix-example/config"
            printf 'development\n' > "$HOME/phenix/repos/phenix-example/config/value"
            test "$(PHENIX_DEV=1 phenix-wrapper-fixture)" = "dev:1:development"
            test "$(PHENIX_DEV=0 phenix-wrapper-fixture-dev)" = "dev:1:development"
            ...
            test "$(PHENIX_ROOT="$custom_root" phenix-wrapper-fixture-dev)" = "dev:1:custom"
            ...
            if PHENIX_ROOT="$TMPDIR/missing" phenix-wrapper-fixture-dev > missing.log 2>&1; then
